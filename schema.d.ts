...
export interface paths {
    "/v2.0/{season}/advancement/{eventCode}": {
        ...
        get: {
            parameters: {
                query?: {
                    /** @description `excludeSkipped=true` to exclude skipped advancement slots. Slots are skipped if no team meets the criteria, the team has already advanced, the team declined, or the team was ineligible. */
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["AdvancementModel"];
                    };
                };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["AdvancementSourceModel"][];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["LeagueMemberListModel"];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["EventRankingsModel"];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["ApiIndexModel"];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["MatchScoresModel"];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["SeasonAwardListingsModel"];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json":
                            components["schemas"]["AwardsModel"];
                    };
                };
                /** @description Unauthorized */
                401: {
...
export interface components {
    schemas: {
        ...
        AdvancementSlot: {
            ...
            /**
             * Format: int32
             * @description The number of the advancement criteria
             */
            slot?: number;
            /** @description String describing the advancement criteria */
            criteria?: string | null;
            /** @description true if the team declined their advancement invitation */
            declined?: boolean;
        ...
        AllianceSelectionModel_Version2: {
            alliances?:
                | components["schemas"]["AllianceModel_Version2"][]
                | null;
            /** Format: int32 */
            count?: number;
        };
        ...
        /** @enum {string} */
        AutoLocation: "NONE" | "OBSERVATION_ZONE" | "ASCENT";
        /** @enum {string} */
        AutoNavigatedStatus:
            | "NONE"
            | "IN_STORAGE"
        ...
        CoordinateSequence: {
            ...
            first?: components["schemas"]["Coordinate"];
            last?: components["schemas"]["Coordinate"];
            /** Format: int32 */
        ...
        EventMatchResultsModel_Version2: {
            matches?:
                | components["schemas"]["MatchResultModel_Version2"][]
                | null;
        };
        /** Event Ranking List */
        EventRankingsModel: {
        ...
        EventScheduleHybridModel_Version2: {
            schedule?:
                | components["schemas"]["ScheduleHybridModel_Version2"][]
                | null;
        };
        /** Scheduled Match List */
        EventScheduleModel_Version2: {
            schedule?:
                | components["schemas"]["ScheduledMatchModel_Version2"][]
                | null;
        };
        /** @enum {string} */
        ...
        Geometry: {
            ...
            readonly coordinates?: components["schemas"]["Coordinate"][] | null;
            /** Format: int32 */
        ...
        MatchResultModel_Version2: {
            ...
            teams?:
                | components["schemas"]["MatchResultTeamModel_Version2"][]
                | null;
            /** Format: date-time */
        ...
        MatchScoresModel: {
            matchScores?:
                | (
                    | components["schemas"]["ScoreDetailModel_2019"]
                    | components["schemas"]["ScoreDetailModel_2020"]
                    | components["schemas"]["ScoreDetailModelSinglePlayer_2020"]
                    | components["schemas"]["ScoreDetailModel_2021"]
                    | components["schemas"]["ScoreDetailModelSinglePlayer_2021"]
                    | components["schemas"]["ScoreDetailModel_2022"]
                    | components["schemas"]["ScoreDetailModelSinglePlayer_2022"]
                    | components["schemas"]["ScoreDetailModel_2023"]
                    | components["schemas"]["ScoreDetailModelSinglePlayer_2023"]
        ...
        NtsGeometryServices: {
            ...
            coordinateEqualityComparer?:
                components["schemas"]["CoordinateEqualityComparer"];
            /** Format: int32 */
        ...
        ScheduledMatchModel_Version2: {
            ...
            matchNumber?: number;
            teams?:
                | components["schemas"]["ScheduledMatchTeamModel_Version2"][]
                | null;
            /** Format: date-time */
            modifiedOn?: string | null;
        };
        ...
        ScheduleHybridModel_Version2: {
            ...
            teams?:
                | components["schemas"]["ScheduleHybridModelTeam_Version2"][]
                | null;
        };
        ...
        ScoreDetailAllianceModel_2022: {
            ...
            autoJunctions?:
                | components["schemas"]["JunctionElement"][][][]
                | null;
        ...
        /** CenterStage Alliance Score Breakdown */
        ...
        /** IntoTheDeep Alliance Score Breakdown */
        ScoreDetailAllianceModel_2024: {
            robot1Auto?: components["schemas"]["AutoLocation"];
            robot2Auto?: components["schemas"]["AutoLocation"];
            /** Format: int32 */
            ...
            robot1Teleop?: components["schemas"]["TeleopLocation"];
            robot2Teleop?: components["schemas"]["TeleopLocation"];
            /** Format: int32 */
            minorFouls?: number;
            /** Format: int32 */
            majorFouls?: number;
        ...
        ScoreDetailModel_2019: {
            ...
            matchNumber?: number;
            alliances?:
                | components["schemas"]["ScoreDetailModelAlliance_2019"][]
                | null;
        };
        ...
        ScoreDetailModel_2020: {
            ...
            matchNumber?: number;
            alliances?:
                | components["schemas"]["ScoreDetailAllianceModel_2020"][]
                | null;
        };
        ...
        ScoreDetailModel_2021: {
            ...
            alliances?:
                | components["schemas"]["ScoreDetailAllianceModel_2021"][]
                | null;
        };
        ...
        ScoreDetailModel_2022: {
            ...
            randomization?: number;
            alliances?:
                | components["schemas"]["ScoreDetailAllianceModel_2022"][]
                | null;
        };
        /** CenterStage Alliance Score Details */
        ScoreDetailModel_2023: {
            ...
            randomization?: number;
            alliances?:
                | components["schemas"]["ScoreDetailAllianceModel_2023"][]
                | null;
        };
        /** IntoTheDeep Alliance Score Details */
        ScoreDetailModel_2024: {
            matchLevel?: components["schemas"]["FTCEventLevel"];
            /** Format: int32 */
            matchSeries?: number;
            /** Format: int32 */
            ...
            randomization?: number;
            alliances?:
                | components["schemas"]["ScoreDetailAllianceModel_2024"][]
                | null;
        };
        ...
        /** CenterStage Single Team Score Details */
        ...
        ScoreDetailSinglePlayer_2022: {
            initSignalSleeve?: boolean;
            robotAuto?: components["schemas"]["AutoNavigation"];
            /** Format: int32 */
            autoTerminal?: number;
        ...
        /** CenterStage Remote Score Breakdown */
        ScoreDetailSinglePlayer_2023: {
            ...
            /** Format: int32 */
            maxSetLine?: number;
            egRobot?: components["schemas"]["EndGameLocation"];
            /** Format: int32 */
            drone?: number;
            /** Format: int32 */
            minorPenalties?: number;
        ...
        SeasonEventListingsModel_Version2: {
            events?:
                | components["schemas"]["SeasonEventModel_Version2"][]
                | null;
            /** Format: int32 */
            eventCount?: number;
        };
        ...
        SeasonLeagueListingsModel_Version2: {
            leagues?:
                | components["schemas"]["SeasonLeagueModel_Version2"][]
                | null;
            /** Format: int32 */
            leagueCount?: number;
        };
        ...
        SeasonSummaryModel_Version2: {
            ...
            teamCount?: number;
            frcChampionships?:
                | components["schemas"]["SeasonSummaryModelChampionship"][]
                | null;
        };
